...
**👋 Using TLabel?** We'd love to hear about your use case! It takes just [2 minutes →](USER_SURVEY.md)
...
### 🎯 Share Your Use Case (2 minutes)
Using TLabel? Help us understand how you're using it!

**[Take the 2-minute User Survey →](USER_SURVEY.md)**
...
### 🤝 Join the Community
- **GitHub Discussions**: Ask questions, share workflows, connect with other users
  - [💬 Start a Discussion](https://github.com/liesliy/tlabel/discussions)
  
- **Report Issues**: Found a bug or have a feature idea?
  - [🐛 Bug Report](https://github.com/liesliy/tlabel/issues/new?template=bug_report.md)
  - [💡 Feature Request](https://github.com/liesliy/tlabel/issues/new?template=feature_request.md)
  - [📝 Usage Feedback](https://github.com/liesliy/tlabel/issues/new?template=usage_feedback.md)

- **Email**: Reach out directly at luoxi@touchlabelai.cn

### 🌟 Show Your Support
If TLabel saves you time:
- ⭐ **Star this repo** (helps others find it)
- 📦 **Cite in your paper** (see [Citation](#-citing-tlabel))
- 📢 **Share with colleagues** (word of mouth matters!)
